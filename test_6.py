...
#
#     return tam_eded(list(reversed(n)))
#
#
# print(tam_eded(12))
...
#         return False
#
#     return polindrom(a[1:],b[:-1])
#
# print(polindrom('ana','ana'))
...
users = [ ["Alice", 30], ["Bob", 24], ["Charlie", 28], ["Diana", 35], ["edward", 29], ]
